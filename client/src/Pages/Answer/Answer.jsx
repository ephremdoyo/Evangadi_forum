      ...
      <section className={classes.answer_inner_container}>
        ...
        <div className={classes.question_section}>
          <div style={{ display: "flex" }}>
            ...
            />
            <h5 className={classes.question_title}>{singleQuestion.title}</h5>
          </div>
              ...
              answer.map((singleAnswer) => {
                ...
                const answerSec = (
                  <div>
                    ...
                    >
                      <div>
                        <FaUserCircle size={55} style={{ color: "#022553" }} />
                        <p>{username}</p>
                      </div>
                      <div className={classes.answer_container}>{answer}</div>
                    </div>
                    <div className={classes.answer__user_border_bottom}></div>
                  </div>
                );
                return answerSec;
              })
